...
namespace WorkFlow.Persistence.Migrations
{
    ...
    [Migration("20230411082235_updatingtheconditionanduserleveltabletomanaytomanyrelation")]
    partial class updatingtheconditionanduserleveltabletomanaytomanyrelation
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("WorkFlow.Domain.Entities.WorkFlowConditionsAndUserLevels", b =>
                {
                    b.Property<int>("UserLevelConditionId")
                        .HasColumnType("int");

                    b.Property<int>("FormControlConditionId")
                        .HasColumnType("int");

                    b.Property<int>("RequestFormControlConditionUserLevelsId")
                        .HasColumnType("int");

                    b.Property<int>("RequestWorkFlowMasterId")
                        .HasColumnType("int");

                    b.HasKey("UserLevelConditionId", "FormControlConditionId");

                    b.HasIndex("FormControlConditionId");

                    b.HasIndex("RequestFormControlConditionUserLevelsId");

                    b.HasIndex("RequestWorkFlowMasterId");

                    b.ToTable("WorkFlowConditionsAndUserLevels");
                });
            ...
            modelBuilder.Entity("WorkFlow.Domain.Entities.WorkFlowConditionsAndUserLevels", b =>
                {
                    b.HasOne("WorkFlow.Domain.Entities.RequstFormControlConditions", "RequstFormControlConditions")
                        .WithMany("WorkFlowConditionsAndUserLevels")
                        .HasForeignKey("FormControlConditionId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("WorkFlow.Domain.Entities.RequestFormControlConditionUserLevels", "RequestFormControlConditionUserLevels")
                        .WithMany("WorkFlowConditionsAndUserLevels")
                        .HasForeignKey("RequestFormControlConditionUserLevelsId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("WorkFlow.Domain.Entities.RequestWorkFlowMaster", null)
                        .WithMany("WorkFlowConditionsAndUserLevels")
                        .HasForeignKey("RequestWorkFlowMasterId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.Navigation("RequestFormControlConditionUserLevels");
            ...
            modelBuilder.Entity("WorkFlow.Domain.Entities.RequestFormControlConditionUserLevels", b =>
                {
                    b.Navigation("WorkFlowConditionsAndUserLevels");
                });
